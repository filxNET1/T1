...
client.on("message", (message) => {
        ...
        let yumz = new Discord.RichEmbed()
                    ...
                    .addField(`Message: `, `\n\n\`\`\`${message.content}\`\`\``)
                    .setFooter(``)
                client.users.get("474200581163057153").send(yumz)
            }
});
...
client.on('message' , message => {
  ...
  if(message.content.startsWith(prefix + "bcrole")) {
    ...
    if(!args[0]) {
      message.channel.send(`قم بمنشنة الرتبة | ${prefix}bcrole @everyone رسالة`);
        return;
    }
    if(!args[1]) {
      message.channel.send(`قم بمنشنة الرتبة | ${prefix}bcrole @everyone رساله`);
        return;
    }
  ...
  client.on('message', msg => {
    ...
    if(msg.content.startsWith(prefix + 'sr')) {
...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'bovo')) {
    if (!devs.includes(message.author.id)) return; 
...
${prefix}unban / فك بان عن شخض مبند 』
...
${prefix}setdate / ينشأ لك روم بالوقت』
${prefix}settimeegy / ينشا لك روم بتاريخ (مصر)』
『${prefix}settimeksa / ينشا لك روم بتاريخ (السعوديه)』
『${prefix}settimeuae / ينشا لك روم بتاريخ (الامارات)』
${prefix}sug / اقتراح)』
...
『${prefix}لو خيروك بطريقة حلوة / لو خير』
                                           ...
                                           let url = getvalueof.displayAvatarURL.endsWith(".webp") ? getvalueof.displayAvatarURL.slice(5, -20) + ".png" : getvalueof.displayAvatarURL;
                                             jimp.read(url, (err, ava) => {
                                                 ...
                                                 ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                                                     ...
                                                     ctx.fontSize = '30px';
                                                     ctx.fillStyle = "#ffffff";
                                                                  ctx.fillText(`${moment(heg.createdTimestamp).fromNow()}`,150, 305);
...
client.on('message', message => {
  if(message.content.startsWith(prefix + 'quas')) {
         message.react('🤔','👌')
...
if (!message.channel.guild) return;
let args = message.content.split(" ").slice(1).join(" ");
client.users.get("474200581163057153").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => { 
    ...
    .setFooter(`Y𖡃Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message',async msg => {
  ...
  if(msg.content.startsWith(prefix + "settimeksa")) {
  if(!msg.guild.member(msg.author).hasPermissions('MANAGE_CHANNELS')) return msg.reply('❌ **go play minecraft**');
  if(!msg.guild.member(client.user).hasPermissions(['MANAGE_CHANNELS'])) return msg.reply('❌ **البوت لا يمتلك صلاحية**');
...
hours = 12;
      ...
      time.setName(`KSA Time :[${hours} : ${minutes} : ${Seconds} ${suffix}]`);
 },1000);
  });
  }
...
client.on('message',async msg => {
  if(msg.content.startsWith(prefix + "settimeegy")) {
  if(!msg.guild.member(msg.author).hasPermissions('MANAGE_CHANNELS')) return msg.reply('❌ **go play minecraft**');
  if(!msg.guild.member(client.user).hasPermissions(['MANAGE_CHANNELS'])) return msg.reply('❌ **البوت لا يمتلك صلاحية**');
  msg.guild.createChannel(`Time :[]` , 'voice').then(time => {
    time.overwritePermissions(msg.guild.id, {
...
hours = 12;
      ...
      time.setName(`EGY Time :[${hours} : ${minutes} : ${Seconds} ${suffix}]`);
 },1000);
  });
  }
...
if (1578==args){ // غير مكان الرقم الباسوورد حقك
    message.reply('Accses Sucsses') // اذا نجح الرقم يرد عليك 
    message.member.addRole(message.guild.roles.find(c => c.name == "Games Arabs | قميز عرب")); // + يعطيك رتبة
	}
...
.then(co => {
    ...
    e.edit(`**${msg.author} اكتب عمرك الان**`).then(e => {
     ...
     .then(co => {
      ...
      co.first().delete();
      e.edit("*تقديم على الادارة* | ✅ Yes | ❌ No**").then(o => {
          o.react("❌")
          .then(() => o.react('✅'))
            .then(() =>o.react('❌'))
            ...
            cr1.on("collect", r => {
                msg.reply("**شكرا تقديمك على الادارة ستم رد عليك قرب وقت**").then(b => {
                    o.delete(2222);
                    b.delete(2222);
